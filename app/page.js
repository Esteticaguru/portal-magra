...
<head>
    ...
    <meta name="twitter:site" content="@portalmagra">
    
    <!-- WHATSAPP ESPECÍFICO -->
    <meta property="og:image:alt" content="Portal Magra - Quiz para descobrir que brasileira você é nos Estados Unidos">
    
    <!-- FAVICON -->
    <link rel="icon" href="https://portalmagra.com/favicon.ico">
    <link rel="apple-touch-icon" href="https://portalmagra.com/apple-touch-icon.png">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "WebPage",
      "name": "Que brasileira você é nos Estados Unidos?",
      "description": "Descubra em 1 minuto que tipo de brasileira você é nos EUA! Teste gratuito + guia personalizado de bem-estar.",
      "url": "https://portalmagra.com/quiz",
      "image": "https://portalmagra.com/imagens/quiz-preview.jpg",
      "author": {
        "@type": "Organization",
        "name": "Portal Magra",
        "url": "https://portalmagra.com"
      },
      "publisher": {
        "@type": "Organization",
        "name": "Portal Magra",
        "logo": {
          "@type": "ImageObject",
          "url": "https://portalmagra.com/logo.png"
        }
      }
    }
    </script>
    ...
    <!-- FACEBOOK PIXEL / GOOGLE ANALYTICS (se necessário) -->
    <!-- Seus códigos de tracking aqui -->
    
</head>
<body>
    <!-- SEU CONTEÚDO DO QUIZ AQUI -->
    <!-- O componente React que criamos vai aqui -->
</body>
</html>
